                ...
                <form class="space-y-6" action="{{ route('login') }}" method="POST">
                    ...
                    <div class="relative">
                        ...
                        <div class="relative flex justify-center text-sm">
                            <span class="px-3 bg-white text-slate-500 font-medium">Or continue with</span>
                        </div>
                    </div>
                    ...
                    <div class="grid grid-cols-2 gap-3">
                        <button
                            type="button"
                            class="w-full inline-flex justify-center items-center py-3 px-4 border border-slate-300 rounded-lg shadow-sm bg-white text-sm font-medium text-slate-600 hover:bg-slate-50 hover:border-slate-400 transition-all duration-200 transform hover:scale-[1.02] active:scale-[0.98]"
                        >
